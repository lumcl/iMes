...
public class D402L {
	...
	public int insertDb(Connection conn) throws Exception{
		int i = 0;
		String sql = "INSERT INTO D402L(GSDM,BDDM,BDBH,SQNR,CMATNR,CWERKS,CMATKL,CMAKTX,CMEINS,NETPR,REQQ,REQA,ISSQ,ISSA,CFMDT,CGSM,CGYH,XQSM,JLYH,JLSJ,GXYH,GXSJ,CEKGRP) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
