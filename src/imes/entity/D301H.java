...
public class D301H {
    ...
    public int insertDb(Connection conn) throws Exception {
		int i = 0;
		String sql = "INSERT INTO D301H (GSDM,BDDM,BDBH,BDRQ,BDZT,BDJG,ZCBH,ZCMC,ZCLX,SQBM,BMMC,BDAMT,SQYH,QHYH,QHSJ,JLYH,JLSJ,GXYH,GXSJ,BDFD,WCRQ,ZCCB,BGR,ZBDT,ZCBG,ADDR,ZMJZ,QTY,QCNR,QDJZ) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
