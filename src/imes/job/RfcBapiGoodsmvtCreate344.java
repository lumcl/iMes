...
public class RfcBapiGoodsmvtCreate344 implements Runnable {
	private ServletContext context;

	private Logger logger = Logger.getLogger(this.getClass());

	public RfcBapiGoodsmvtCreate344(ServletContext context) {
		super();
	...
	public void run() {
		...
		// TODO Auto-generated method stub
		logger.info("RfcBapiGoodsmvtCreate344 Start Up");
		try {
			//ReadWMD04POS();
		...
		logger.info("RfcBapiGoodsmvtCreate44 Shutdown");
	}
	...
	public void ReadStkLocationTransferData()  throws Exception{
		...
		String sql="SELECT * FROM SAPWEB.WI_MVT311S WHERE WERKS = '382A'";
	...
	public void CreateStockMovement(List<HashMap<String, String>> list) throws Exception {
		...
		header.setValue("PSTNG_DATE", "20140520");
		header.setValue("DOC_DATE", "20140520");
