...
public class UserAuthenticate {
	private String URL = "ldap://172.28.1.253:389/";
    private String BASEDN = "o=leader";//ou=tx, or ou=dt  or ou=ph  or ou=tp  ;
    ...
    public static void main(String[] args){
    	...
    	try{
	    	ua.authenricate("felix.jiang@l-e-i.com", "leitx999");
	    	System.out.println(" is successed");
	    	System.out.println(ua.getUserDN("felix.jiang@l-e-i.com"));
	    	System.out.println(" is successed!!!!");
    	}catch(Exception e){}
