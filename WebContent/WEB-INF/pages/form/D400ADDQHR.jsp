...
<script type="text/javascript" src="/iMes/javascript/D400ADDQHR.js"></script>
  ...
  function submitQianHe() {
    jQuery.ajax({
      ...
      if (msg == "") {
        ...
        alert("會簽人  Countersign: " + msg + "不存在, 請修正會簽人后再保存.Does not exist, please countersign after correction to save.");
      }
    });
  }
...
<div id="tabs">
 ...
 <div id="tab-1">
  <form action="/iMes/D400/ADDQHR" method="post" id="D400QHFRM">
   <input type="hidden" name="GSDM" value="${D400.GSDM}">
   <input type="hidden" name="BDDM" value="${D400.BDDM}">
   <input type="hidden" name="BDBH" value="${D400.BDBH}">
   <input type="hidden" name="BDTX" value="${D400.QCAY}">
