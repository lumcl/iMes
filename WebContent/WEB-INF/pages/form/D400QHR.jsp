...
<div id="tabs">
 ...
 <div id="tab-1">
  <form action="/iMes/D400/GLYQH" method="post" id="D400QHFRM">
   ...
   <table id="SHRTAB">
    <caption>選擇簽呈審核人<br/>Select the petition audit</caption>
    <tbody>
     <tr id="ROWS">
   ...
   <table id="HQRTAB">
    <caption>選擇簽呈會簽人<br/>Select the petition countersign</caption>
    <tbody>
     <tr id="HQRROWS">
      <td>會簽人<br/>Countersign person</td>
   ...
   <table id="SHRTAB">
    <caption>選擇簽呈核準人<br/>Select the petition approved</caption>
    <tbody>   
     <tr>
   ...
   <table id="ZXRTAB">
    <caption>選擇簽呈知悉人<br/>That people choose petition</caption>
    <tbody>
     <tr id="ZXRROWS">
      <td>知悉人<br/>Know people</td>
...
<caption>簽核記錄  Check record</caption>
 <thead>
  <tr>
   ...
   <th>通知Notice<br />核准時間 Approval time
   </th>
   <th>結果<br/>Results</th>
   <th>文件<br/>File</th>
   <th>內容<br/>Content</th>
    ...
    <tbody>
     ...
     <tr>
      ...
      <td>${sessionScope.uid} &nbsp;: &nbsp;<select name="QHJG">
        <option value="Y" selected="selected">同意Agreed</option>
        <option value="N">不同意Disagree</option>
      </select> &nbsp;&nbsp; 重簽 &nbsp;Re-sign<input type="checkbox" name="YHCQ">
      </td>
      <td align="right">
      </td>
     </tr>
