...
<script type="text/javascript" src="/iMes/javascript/D189ADDQHR.js"></script>
...
<div id="tabs">
 ...
 <ul>
  <li><a href="#tab-1">Add Person<br />加簽核人</a></li>
 </ul>
 
 <div id="tab-1">
  <form action="/iMes/D189/ADDQHR" method="post" id="D189QHFRM">
   <input type="hidden" name="GSDM" value="${D189.GSDM}">
   <input type="hidden" name="BDDM" value="${D189.BDDM}">
   <input type="hidden" name="BDBH" value="${D189.BDBH}">
   <input type="hidden" name="BDTX" value="${D189.CGYY}">
   <div id="icon">
    ...
    <button type="button" id="SBMQHBTN" onclick="this.disabled=true;">
      <img src="/iMes/stylesheet/icons/S_F_SAVE.GIF" alt="加簽核人" />
    </button>
    
   </div>

   <table id="SHRTAB">
    <caption>Select Auditing person<br />選擇簽呈審核人</caption>
    <tbody>
     <tr id="ROWS">
      <td>審核人</td>
   ...
   <table id="HQRTAB">
    <caption>Select Countersignature person<br />選擇簽呈會簽人</caption>
    <tbody>
     <tr id="HQRROWS">
      <td>會簽人</td>
   ...
   <table id="SHRTAB">
    <caption>Select Approved person<br />選擇簽呈核準人</caption>
    <tbody>
     <tr>
      <td>核準人</td>
