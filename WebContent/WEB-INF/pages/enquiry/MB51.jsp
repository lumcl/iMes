...
<div id="tabs">
 <ul>
  <li><a href="#tab-1">MB51 - 物料文件清單</a></li>
 </ul>

 <div id="tab-1">
 <form action="MB51" method="post">
   <div id="icon">
   ...
   <table>
    ...
    <tr>
     ...
     <td><input type="text" name="usnam_low" size="10" value=${param.usnam_low }></td>
    ...
    <tr>
     ...
     <td><input type="text" name="usnam_high" size="10" value=${param.usnam_high }></td>
   ...
   <tbody>
    <c:forEach items="${list}" var="e">
     <tr>
      ...
      <td class="dec4" bgcolor="#ccecff"><fmt:formatNumber value="${e.LABST}" pattern="#,###.###" /></td>
      <td class="dec4" bgcolor="#ccecff"><fmt:formatNumber value="${e.INSME}" pattern="#,###.###" /></td>
      <td>${e.AUFNR}</td>
      <td>${e.PMATNR}</td>
      <td>${e.PWERK}</td>
      <td>${e.LIFNR}</td>
      ...
      <td>${e.KNAME}</td>
      <td>${e.KDAUF}</td>
      <td class="dec4"><fmt:formatNumber value="${e.KDPOS}" pattern="#,###.###" /></td>
      <td>${e.MBLNR}</td>
      <td>${e.MJAHR}</td>
